                ...
                <div class="col">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title"><?= Yii::t('app', 'Task information') ?></h3>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
                            <table class="table">
                                <tbody>
                                    ...
                                    <tr>
                                        <th><?= $model->getAttributeLabel('task_number') ?></th>
                                        <td><span class="badge bg-info"><?= Html::encode($model->task_number) ?></span></td>
                                    </tr>
                                    <tr>
