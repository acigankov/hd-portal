...
$this->title = Yii::t('app', 'Edit task') . ': ' . Html::encode($model->task_number);
$this->params['breadcrumbs'][] = ['label' => Yii::t('app', 'Tasks'), 'url' => ['index']];
$this->params['breadcrumbs'][] = ['label' => Html::encode($model->task_number), 'url' => ['view', 'id' => $model->id]];
        ...
        <div class="row">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-end">
                    ...
                    <li class="breadcrumb-item"><a href="<?= \yii\helpers\Url::to(['view', 'id' => $model->id]) ?>"><?= Html::encode($model->task_number) ?></a></li>
