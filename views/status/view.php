...
$this->title = Yii::t('app', 'View status') . ': ' . Html::encode($model->name);
                ...
                <div class="col">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title"><?= Yii::t('app', 'Status information') ?></h3>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
                            <table class="table">
                                <tbody>
                                    ...
                                    <tr>
                                        <th><?= $model->getAttributeLabel('is_default') ?></th>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            if ($model->for_tickets) $entityTypes[] = Yii::t('app', 'Tickets');
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php
                                            $badgeClass = $model->status === \app\models\Status::STATUS_ACTIVE ? 'bg-success' : 'bg-secondary';
                                            ?>
