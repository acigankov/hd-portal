                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <?= $form->field($model, 'name')
                                ->textInput(['autofocus' => true, 'placeholder' => Yii::t('app', 'Enter status name')])
                            ...
                            <?= $form->field($model, 'status')
                                ->dropDownList([
                                    \app\models\Status::STATUS_ACTIVE => Yii::t('app', 'Active'),
                                    \app\models\Status::STATUS_INACTIVE => Yii::t('app', 'Inactive'),
                                ])
